...
for filename in glob.glob("mike-08-*.txt"):
...
for filename in glob.glob("mike-06-*.txt"):
...
for filename in glob.glob("mike-04-*.txt"):
...
plt.figure()
plt.title("Lattice mike under purely dephasing error")
